...
const InstagramPost = () => {
    let { instagramPost }: { instagramPost: InstagramType; } = useFetchInstagramPost();
            ...
            <blockquote className="instagram-media" data-instgrm-captioned data-instgrm-permalink={`${instagramPost?.permalink}?utm_source=ig_embed`} data-instgrm-version={14} style={{ background: '#FFF', border: 0, borderRadius: '3px', boxShadow: '0 0 1px 0 rgba(0,0,0,0.5),0 1px 10px 0 rgba(0,0,0,0.15)', margin: '1px', maxWidth: '540px', minWidth: '326px', padding: 0, width: 'calc(100% - 2px)' }}>
                <div style={{ padding: '16px' }}>
                    ...
                    <p style={{ color: '#c9c8cd', fontFamily: 'Arial,sans-serif', fontSize: '14px', lineHeight: '17px', marginBottom: 0, marginTop: '8px', overflow: 'hidden', padding: '8px 0 7px', textAlign: 'center', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
                        <a href={`${instagramPost?.permalink}?utm_source=ig_embed`} style={{ color: '#c9c8cd', fontFamily: 'Arial,sans-serif', fontSize: '14px', fontStyle: 'normal', fontWeight: 'normal', lineHeight: '17px', textDecoration: 'none' }} target="_blank" rel='noreferrer'>
                            Post was shared by Mart (@musicbymart)
                        </a>
                    </p>
                </div>
            </blockquote>
